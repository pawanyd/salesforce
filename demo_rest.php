...
function show_accounts($instance_url, $access_token) {
    ...
    // print_r('show_accounts'. $url); exit;
...
function create_account($name, $instance_url, $access_token) {
    ...
    // print_r('create_account'.$url); exit; 

    // $content = json_encode(array("Name" => $name));
    // Star_Rating__c
    $content = json_encode(array("Name" => "pawan","Phone" => "7737494384","Website" => "www.pawan.com", "Email__c" => "test@gmail.com","Bedrooms__c" => 10));
    ...
    <body>
        <tt>
            ...
            //show_accounts($instance_url, $access_token);
             ...
             $id = create_account("Pawan", $instance_url, $access_token);
